...
function _OnFrame()
    if STEAM_READ ~= 0x8B and ReadString(0x09A98B0, 0x04) == 'KH2J' then
        ...
        WriteArray(0x15EC12, { 0x75, 0x01, 0xC3 }) -- JNE 0x15EC14 / RET
        WriteArray(0x15EC15, { 0x8B, 0x0D, 0xE5, 0x66, 0x8C, 0x02 }) -- MOV ECX, [0x2A25300]
        WriteArray(0x15EC1B, { 0xEB, 0x0B }) -- JMP 0x15EC28
