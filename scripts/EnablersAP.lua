...
function _OnFrame()
    ...
    elseif EPIC_READ ~= 0x8B and ReadString(0x09A9330, 0x04) == 'KH2J' then
        ...
        ConsolePrint("Writing the gateway to Deathlink...")
        WriteArray(0x15E252, { 0xEB, 0x3F }) -- JMP 0x15E293

        ConsolePrint("Writing Deathlink Sub-Routine #1...")
        WriteArray(0x15E293, { 0xE8, 0xC8, 0x61, 0x2A, 0x00 }) -- CALL 0x404460
        WriteArray(0x15E298, { 0x48, 0x8B, 0xC8 }) -- MOV RCX, RAX
        WriteArray(0x15E29B, { 0xEB, 0x25 }) -- JMP 0x15E2C2

        ConsolePrint("Writing Deathlink Sub-Routine #2...")
        WriteArray(0x15E2C2, { 0x4C, 0x8B, 0xC2 }) -- MOV R8, RDX
        WriteArray(0x15E2C5, { 0x4C, 0x8B, 0xCA }) -- MOV R9, RDX
        WriteArray(0x15E2C8, { 0xE9, 0xC3, 0x3E, 0x27, 0x00}) -- JMP 0x3D2190
